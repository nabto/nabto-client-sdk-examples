...
/**
 * The client config can also contain an url to be
...
{
 public:
    static bool loadClientConfig(const std::string& homedir, const std::string& clientConfigFileName, NabtoClientConnection* connection)
    {
        std::stringstream ss;
